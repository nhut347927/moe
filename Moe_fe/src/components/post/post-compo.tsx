          ...
          <div className="z-30 pointer-events-none absolute bottom-2 left-0 right-0 px-4 flex items-end justify-between">
            <div className="pointer-events-auto opacity-80 mb-2 max-w-3xl w-full mx-auto  flex items-center space-x-3">
              ...
              <Button
                onClick={handleLike}
                className={cn(
                  "min-w-[42px] min-h-[42px] w-[42px] h-[42px] p-2 rounded-full flex items-center justify-center transition-all",
                  postData.isLiked
              ...
              <Button
                ...
                className="min-w-[42px] min-h-[42px] w-[42px] h-[42px] p-2 rounded-full flex items-center justify-center bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-800 dark:hover:bg-zinc-700"
              >
