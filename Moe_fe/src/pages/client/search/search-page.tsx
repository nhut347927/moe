          ...
          <div className="flex items-center gap-2 p-1 mb-4 mt-12">
            <div className="relative flex-1">
              ...
              <Input
                ...
                className="w-full h-11 pl-10 pr-4 rounded-xl text-sm shadow-sm focus:ring-2 focus:ring-primary"
              />
                ...
                {posts.length === 0 && !isLoading ? (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-0.5">
                    {posts.map((post) => (
                      <div
                        key={post.postCode}
                        className="rounded-xl overflow-hidden cursor-pointer relative group mb-3"
