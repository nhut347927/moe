...
import { Post, TabType, commonEmojis } from "../types";
                ...
                <div key={comment.commentCode} className="space-y-3">
                  <div className="flex gap-3">
                    <Avatar className="h-9 w-9">
                      <AvatarImage
                        src={`abc/image/upload/w_80,h_80/${comment.userAvatar}`}
                      />
                              ...
                              <div key={reply.commentCode}>
                                <div className="flex gap-2">
                                  <Avatar className="h-7 w-7">
                                    <AvatarImage
                                      src={`abc/image/upload/w_80,h_80/${reply.userAvatar}`}
                                    />
                                    <AvatarFallback>
                                      {reply.displayName[0]}
                                    </AvatarFallback>
          ...
          >
            ...
            <div className="flex gap-2 items-center pb-11">
              ...
              <Input
                ...
                onFocus={() => setActivePostId(post.postCode)}
                className="flex-1"
                onKeyDown={(e) => {
